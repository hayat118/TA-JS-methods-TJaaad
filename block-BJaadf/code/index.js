...
let newValue=fruits.concat(moreFruits)
...
let oddNumbers=numbersThree.flat(4).filter(
  (elm)=>elm%2!==0
)
// Create a new variable named evenNumbers that store all the even numbers in numbersThree array
let evenNumbers=numbersThree.flat(4).filter(
  (elm)=>elm%2===0
)
// Find the index of 10 in numbersThree array
numbersThree.flat(4).find((num)=>num==10)
